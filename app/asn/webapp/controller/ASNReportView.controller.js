	...
	return Controller.extend("sap.fiori.asn.controller.ASNReportView", {
		...
		handleInvNumHelp: function () {
			...
			if (!this.invNumFragment) {
				this.invNumFragment = sap.ui.xmlfragment("sap.fiori.asn.fragment.fragVendorInvNum", this);
		...
		handlePlantHelp: function () {
			var plantFragment = sap.ui.xmlfragment("sap.fiori.asn.fragment.fragPlant", this);
		...
		handleBaseDocHelp: function () {
			...
			if (!this.baseDocFrag) {
				this.baseDocFrag = sap.ui.xmlfragment("sap.fiori.asn.fragment.fragBaseDocNum", this);
		...
		handleAsnNumHelp: function () {
			...
			if (!this.AsnNumFrag) {
				this.AsnNumFrag = sap.ui.xmlfragment("sap.fiori.asn.fragment.fragAsnNum", this);
		...
		handleMaterialHelp: function () {
			...
			if (!this.materialFrag) {
				this.materialFrag = sap.ui.xmlfragment("sap.fiori.asn.fragment.fragMaterial", this);
		...
		handleVendorCodeHelp: function () {
			...
			if (!this.vendorFrag) {
				this.vendorFrag = sap.ui.xmlfragment("sap.fiori.asn.fragment.fragVendor", this);
			...
			sap.ui.getCore().getModel("oDataModel").read(path, null, null, true,
				function (oData) {
					...
					if (oData.results.length > 0) {
						sap.fiori.asn.controller.formatter.RemoveNull(oData);
